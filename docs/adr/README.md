...
Four decisions shaped PulseLedger v1. All are **accepted** and reflect the code as shipped at
`v1.0.0`; where later work confirmed or extended a decision, the ADR carries an update section
...
carries the intent past the commit boundary, and 004 explains why none of that needs another piece of
infrastructure.
